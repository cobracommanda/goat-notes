...
import { ArrowUpIcon, Copy } from "lucide-react";
  ...
  return (
    <Dialog open={open} onOpenChange={handleOnOpenChange}>
      <DialogTrigger asChild>
        <Button variant="secondary">Ask GOAT</Button>
      </DialogTrigger>
      <DialogContent
      ...
      >
        <DialogHeader>
          <DialogTitle>Ask GOAT About Your Notes</DialogTitle>
          <DialogDescription>
            Our GOAT can answer questions about all of your notes
          </DialogDescription>
        </DialogHeader>
